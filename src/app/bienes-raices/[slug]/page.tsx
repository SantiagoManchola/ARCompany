    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-2 py-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-300 p-6">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium">(323) 289 5945 - (316) 225 7289</span>
                  </div>
                  <div className="flex items-center">
                    <svg
                      className="w-5 h-5 text-amber-600 mr-3"
                    ...
                    <span className="font-medium">arcompanybienesyservicios@gmail.com</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Contenido principal debajo del precio */}
          <div className="order-3 lg:order-2 lg:col-span-2 space-y-8">
          ...
          {/* Columna Lateral - Solo ayuda (abajo en móvil) */}
          <div className="order-4 lg:order-3 lg:col-start-3 lg:row-start-2 lg:col-span-1 lg:hidden">
