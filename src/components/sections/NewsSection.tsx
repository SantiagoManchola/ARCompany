...
export default function NewsSection() {
  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute top-10 right-5 w-40 h-40 bg-amber-100 rounded-full mix-blend-multiply filter blur-xl opacity-40 animate-float" style={{animationDelay: '3s'}}></div>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Stay informed with our latest insights, case studies, and legal updates from our expert team
          </p>
        </div>
