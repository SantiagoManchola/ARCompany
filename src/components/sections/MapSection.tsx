  ...
  return (
    <section className="relative py-10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-1">
        ...
        {/* Map Container */}
        <div className="relative" data-aos="fade-up" data-aos-duration="1300">
          ...
          {/* Map Card */}
          <div className="relative bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1300">
            
            {/* Map Header */}
            <div className="relative bg-gradient-to-r from-amber-400 to-amber-500 p-4" data-aos="fade-up" data-aos-delay="150" data-aos-duration="1300">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center text-white backdrop-blur-sm" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="1300">
                  ...
                  <div className="text-white">
                    <h3 className="text-xl font-bold" data-aos="fade-up" data-aos-delay="220" data-aos-duration="1300">AR Company - Oficina Principal</h3>
                    <p className="hidden sm:block text-amber-100 text-sm" data-aos="fade-up" data-aos-delay="240" data-aos-duration="1300">Carrera 4 No. 10-38 oficina 201 Edificio Vela</p>
                  </div>
                </div>
            ...
            {/* Map Container */}
            <div className="relative h-150 bg-gray-100" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1300">
              {/* Google Maps Embed */}
              <iframe
