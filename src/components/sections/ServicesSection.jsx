      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid gap-8 max-w-6xl mx-auto ${
          ...
          {services.map((service, index) => (
            ...
            >
              <div 
                className="flex flex-col items-center text-center p-9 rounded-xl border border-amber-400/50 bg-black/25 backdrop-blur-sm transform transition-all duration-300 ease-in-out hover:bg-amber-400/10 hover:border-amber-400/60 hover:scale-105 hover:shadow-2xl h-full"
              >
                {/* Icon */}
                <div 
