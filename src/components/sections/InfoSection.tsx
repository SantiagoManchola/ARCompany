...
export default function InfoSection() {
    return (
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="absolute -bottom-30 -left-10 w-72 h-72 bg-amber-100 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse" style={{animationDelay: '2s'}}></div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 space-y-8">          
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                End the game of payroll whack-a-mole with the ability to pay your team 
                <span className="font-semibold text-gray-800"> however you need to</span>, 
              ...
              <div className="flex gap-15 py-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-500 font-medium">Cases Won</div>
                </div>
                <div className="text-center">
